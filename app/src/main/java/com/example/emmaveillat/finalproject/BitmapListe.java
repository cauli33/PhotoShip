...
public class BitmapListe {
     ...
     */
    MyBitmap [] liste = new MyBitmap[tailleMax];
     ...
     */
    public BitmapListe(MyBitmap bmp){
        liste[0] = bmp;
        courant = 0;
        maxNbImgConnu = 0;
    }
     ...
     */
    public void setSuivant(MyBitmap bmp){
